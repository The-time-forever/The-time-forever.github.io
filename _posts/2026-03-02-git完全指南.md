...
date: 2026-03-02
permalink: /posts/2026/03/02/git-complete-guide/
---
...
```mermaid
graph TD
    Blob["Blob<br/>文件内容<br/> <br/>Hello<br/>World"]
...
```mermaid
graph TD
    Tree["Tree<br/>目录结构<br/>---<br/>100644 blob a906 README<br/>100644 blob 3b18 main.c<br/>040000 tree 5b9d src/"]
...
```mermaid
graph TD
    Commit["Commit<br/>---<br/>tree: 5b9d...<br/>parent: a3f2...<br/>author: Zhang San<br/>committer: Zhang San<br/> <br/>commit message:<br/>添加新功能"]
